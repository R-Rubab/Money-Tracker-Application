...
class ETextTheme{
  ...
  static TextTheme lightTextTheme =  TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 37.0, fontWeight: FontWeight.bold,color: Colors.black),
  ...
  static TextTheme dartTextTheme =  TextTheme( 
   headlineLarge: const TextStyle().copyWith(fontSize: 37.0, fontWeight: FontWeight.bold,color: Colors.white),
